...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-xl bg-muted/80 backdrop-blur-md p-1 text-muted-foreground shadow-sm border border-white/10 transition-all duration-300 overflow-x-auto flex-nowrap max-w-full',
      className,
    )}
    {...props}
  />
